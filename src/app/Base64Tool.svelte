<script>
  ...
  function encode() {
    error = '';
    if (!input) {
      error = 'Ingresa texto para codificar';
      return;
    }
    try {
  ...
  function decode() {
    error = '';
    if (!input) {
      error = 'Ingresa Base64 para decodificar';
      return;
    }
    try {
...
<div class="tool-panel" id="panel-base64">
  <div class="panel-header">
    ...
    <p>
      Codifica texto a Base64 o decodifica Base64 a texto. También convierte archivos a Data URL.
    </p>
  </div>

  <div
    class="base64-file-zone"
    role="button"
    tabindex="0"
  ...
  <textarea
    ...
    placeholder={mode === 'encode'
      ? 'Pega aquí el texto para codificar a Base64...'
      : 'Pega aquí el Base64 para decodificar...'}
  ></textarea>
